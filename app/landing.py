...
<body>
    ...
    <section class="hero">
        ...
        <div class="hero-badge">Cansado de llamadas que no necesitabas contestar?</div>
        <h1>Deja de perder tiempo<br><span>en llamadas innecesarias.</span></h1>
        <p class="hero-sub">Spam, recordatorios que podian ser un mensaje, llamadas en reuniones, fuera de horario, numeros desconocidos que interrumpen tu concentracion. Dora contesta por ti, filtra lo importante y te avisa por WhatsApp. Tu decides si devolver la llamada.</p>
        ...
        <p style="color: var(--text-muted); font-size: 0.85rem; margin-top: 20px; opacity: 0.7;">Activar toma 30 segundos. Desactivar tambien. Sin contratos.</p>
    </section>

    <!-- PAIN POINTS -->
    <section style="padding: 60px 24px 20px; max-width: 800px; margin: 0 auto;">
        ...
        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 16px; margin-top: 24px;">
            <div style="background: rgba(239,68,68,0.08); border: 1px solid rgba(239,68,68,0.2); border-radius: 14px; padding: 20px; text-align: center;">
                ...
                <p style="color: var(--text-secondary); font-size: 0.9rem;">Otra llamada de spam que te saco de lo que estabas haciendo</p>
            </div>
            <div style="background: rgba(239,68,68,0.08); border: 1px solid rgba(239,68,68,0.2); border-radius: 14px; padding: 20px; text-align: center;">
                <div style="font-size: 1.8rem; margin-bottom: 8px;">🔇</div>
                <p style="color: var(--text-secondary); font-size: 0.9rem;">Llamadas en reuniones, en la noche, o cuando necesitas concentrarte</p>
            </div>
            <div style="background: rgba(239,68,68,0.08); border: 1px solid rgba(239,68,68,0.2); border-radius: 14px; padding: 20px; text-align: center;">
                <div style="font-size: 1.8rem; margin-bottom: 8px;">🤷</div>
                <p style="color: var(--text-secondary); font-size: 0.9rem;">Numero desconocido: era importante o era spam? Nunca lo sabras</p>
            </div>
        </div>
    </section>
            ...
            <table style="width: 100%; border-collapse: collapse; font-size: 0.88rem;">
                ...
                <tbody>
                    <tr style="border-bottom: 1px solid #334155;">
                        ...
                        <td style="padding: 10px 8px; text-align: center; color: var(--primary-light);">$6.99/mes</td>
    ...
    <section class="cta">
        ...
        <p>Deja que Dora se encargue. 7 dias gratis, sin tarjeta, sin compromisos. Recupera tu concentracion y tu tiempo.</p>
        <a href="{planes_url}" class="btn btn-primary" style="font-size:1.1rem; padding:16px 40px;">Empezar gratis</a>
