...
const MODOS = [
  {
    ...
    titulo: "Dora la OperaDora",
    icono: "📞",
    descripcion: "Dora saluda, escucha el recado y te envia un resumen. Incluido en Estudiante y superior.",
    requiereAudio: false,
    planMinimo: "free",
  },
  {
    key: "contestadora",
    titulo: "Dora la GrabaDora",
    icono: "🎙️",
    descripcion: "Tu voz grabada como saludo. Dora escucha y toma recados con tu estilo. Plan Adulto y Ejecutivo.",
    requiereAudio: true,
    planMinimo: "pro",
  },
  {
    key: "agente_ia",
    titulo: "Dora la AgendaDora",
    icono: "🐙",
    descripcion: "Tu secretaria digital con 8 tentaculos: conversa, agenda, filtra y gestiona. Solo plan Ejecutivo.",
    requiereAudio: true,
    planMinimo: "premium",
  },
];
